...
public class UserActionService {
  ...
  public HttpStatus commentOnPost(Comment comment) {
    Optional<CommunityPost> communityPostOpt =
        communityRepository.findById(comment.getParentPost().getId());
  ...
  public List<CommunityPost> getAllPosts() {
    Optional<List<CommunityPost>> posts =
        communityRepository.findByUsername(
